...
const Column = ({ column, createNewCard, deleteColumnInBoard }) => {
        ...
        >
          ...
          >
            <MenuItem 
              ...
              sx={{
                '&:hover': { color: 'primary.dark', '& .addCardIcon': { color: 'primary.dark' } }
              }}
            >
              <ListItemIcon>
            ...
            <MenuItem 
              ...
              sx={{
                '&:hover': { color: 'warning.dark', '& .deleteIcon': { color: 'warning.dark' } }
              }}
            >
              <ListItemIcon>
