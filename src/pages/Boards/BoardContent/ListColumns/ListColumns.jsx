...
const ListColumns = ({ columns, createNewColumn, createNewCard, deleteColumnInBoard }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          {columns?.map((column) => {
            return <Column createNewCard={createNewCard} deleteColumnInBoard={deleteColumnInBoard} key={column._id} column={column} />
          })}
